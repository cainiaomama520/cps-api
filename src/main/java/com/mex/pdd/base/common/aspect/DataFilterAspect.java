...
public class DataFilterAspect {
    ...
    @Pointcut("@annotation(com.mex.pdd.base.common.annotation.DataFilter)")
...
//        if (user.getUserId() == Constant.SUPER_ADMIN) return;
        ...
        if (params != null && params instanceof Map) {
            ...
            DataFilterThreadLocalContext.set(sqlFilter);
        }
